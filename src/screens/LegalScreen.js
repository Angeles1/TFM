...
const LegalScreen = ( props) => {
    ...
    const createAccountHandler = async () => {
        await firebase.auth.createUserWithEmailAndPassword(route.params.email, route.params.password)
            .then(() => {
...
Unauthorised use of this website may give rise to a claim for damages and/or be a criminal offence.</Text>
            ...
            <TouchableOpacity onPress={ createAccountHandler} style={ styles.button  }><Text style={styles.buttonLabel}>Accept</Text></TouchableOpacity>
      </View>
    );
  }
